...
public class Generator {
    ...
    // 表名,多个表使用英文逗号分割
    private static final String[] TBL_NAMES = {"confirm_order","deliveryman","follow_order","order","recipient_address","return_order","sending_address","site"};
